...
public static String transcribe(String fileURL, String language) throws IOException {
	...
	if (CDR.retrieveFile(fileURL,fileName)==false){
		String transcription="fileURL="+fileURL+", fileName="+fileName+", fileNameExt="+fileNameExt;
	...
	CDR.storeFile(targetName,"test_audio2.wav","audio/wav");	
    ...
    //	configuration.setLanguageModelPath("file:acoustic_models/Spanish/cmu_spanish/es-20k.lm.bin");
    //   // //alternativelly 
    ...
    //	//configuration.setLanguageModelPath("file:acoustic_models/Spanish/spanish 2/voxforge-es-0.2/etc/voxforge_es_sphinx.transcription.test.lm");
		...
		configuration.setLanguageModelPath("file:acoustic_models/Spanish/cmu_spanish/es-20k_expanded.lm.bin");
		configuration.setAcousticModelPath("file:acoustic_models/Spanish/spanish 2/voxforge-es-0.2/model_parameters/voxforge_es_sphinx.cd_ptm_3000");
	...
	configuration.setDictionaryPath("file:acoustic_models/Greek/cmusphinx-el-gr-5.2/el-gr_new11.dic");
       ...
       // configuration.setLanguageModelPath("file:acoustic_models/English/en-us.lm.bin");
    	...
    	InputStream stream = new FileInputStream(new File(targetName));
